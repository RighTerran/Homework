...
Console.Write("Введите координату х1 точки A: ");
...
Console.Write("Введите координату х2 точки B: ");
...
Console.WriteLine("Расстояние = " + Math.Round(GetLength(x1,y1,z1,x2,y2,z2),2));
